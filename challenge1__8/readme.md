...
This folder contains an implementation of a Deep Q-Network (DQN) agent trained on the Atari environment *ALE/Phoenix-v5* using Stable-Baselines3. The project includes hyperparameter sweeps, reproducible experiments using multiple random seeds, and logging through TensorBoard.
